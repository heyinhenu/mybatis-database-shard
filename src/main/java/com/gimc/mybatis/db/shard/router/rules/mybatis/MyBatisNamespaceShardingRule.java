...
public class MyBatisNamespaceShardingRule extends AbstractIBatisOrientedRule {

    private transient final Logger logger = LoggerFactory.getLogger(MyBatisNamespaceShardingRule.class);

    public MyBatisNamespaceShardingRule(String pattern, String action, String attributePattern) {
    ...
    public String toString() {
        return "MyBatisNamespaceShardingRule [getAttributePattern()=" + getAttributePattern() + ", getAction()=" + getAction() + ", getTypePattern()="
            + getTypePattern() + "]";
    }
