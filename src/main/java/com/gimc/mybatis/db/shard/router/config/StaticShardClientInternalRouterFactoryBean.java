...
/**
 * with StaticShardClientInternalRouterFactoryBean, you can configure rules
 * directly in spring's IoC container.<br>
 * that's, declaring bean definitions of {@link InternalRule} directly as
 * dependency of {@link StaticShardClientInternalRouterFactoryBean}.
 *
 * @author fujohnwang
 * @see DefaultShardClientInternalRouterXmlFactoryBean for another alternative
 *      which will load rule definitions from external xml.
 */
public class StaticShardClientInternalRouterFactoryBean extends AbstractShardClientInternalRouterFactoryBean {
