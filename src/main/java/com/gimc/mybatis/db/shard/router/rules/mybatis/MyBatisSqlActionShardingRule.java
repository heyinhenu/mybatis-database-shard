...
public class MyBatisSqlActionShardingRule extends AbstractIBatisOrientedRule {

    private transient final Logger logger = LoggerFactory.getLogger(MyBatisSqlActionShardingRule.class);

    public MyBatisSqlActionShardingRule(String pattern, String action, String attributePattern) {
        super(pattern, action, attributePattern);
    }

    public boolean isDefinedAt(MyBatisRoutingFact routingFact) {
    ...
    public String toString() {
        return "MyBatisSqlActionShardingRule [getAttributePattern()=" + getAttributePattern() + ", getAction()=" + getAction() + ", getTypePattern()="
            + getTypePattern() + "]";
    }
