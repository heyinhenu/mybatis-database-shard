 ...
 * @since 1.0
 */
public class MyBatisNamespaceRule extends AbstractIBatisOrientedRule {

    public MyBatisNamespaceRule(String pattern, String action) {
    ...
    public String toString() {
        return "MyBatisNamespaceRule [getAction()=" + getAction() + ", getTypePattern()=" + getTypePattern() + "]";
    }
