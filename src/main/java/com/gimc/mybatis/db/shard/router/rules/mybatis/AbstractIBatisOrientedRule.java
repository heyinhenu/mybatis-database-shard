...
import com.gimc.mybatis.db.shard.router.rules.AbstractEntityAttributeRule;
 ...
 * @since 1.0
 */
public abstract class AbstractIBatisOrientedRule extends AbstractEntityAttributeRule<MyBatisRoutingFact, List<String>> {
