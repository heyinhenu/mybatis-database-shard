...
import com.gimc.mybatis.db.shard.AbstractTestNGCobarClientTest;
import com.gimc.mybatis.db.shard.entities.Offer;
import com.gimc.mybatis.db.shard.test.services.IOfferService;

/**
 * H2 In-Memory Database doesn't support transaction, so in this test case, we need to turn to non-in-memory database to test the transaction.<br>
 *
 * @author fujohnwang
 */
