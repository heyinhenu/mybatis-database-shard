...
public class ShardSqlSessionTemplateWithComposedRuleRouterTest extends AbstractTestNGCobarClientTest {

    private static final String OFFER_CREATION_SQL = "com.alibaba.cobar.client.entities.Offer.create";

    public ShardSqlSessionTemplateWithComposedRuleRouterTest() {
