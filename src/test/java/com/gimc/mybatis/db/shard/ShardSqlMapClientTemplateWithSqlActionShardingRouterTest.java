...
public class ShardSqlMapClientTemplateWithSqlActionShardingRouterTest extends AbstractTestNGCobarClientTest {

    private transient final Logger logger = LoggerFactory.getLogger(ShardSqlMapClientTemplateWithSqlActionShardingRouterTest.class);

    private String[] names = {"Aaron", "Amily", "Aragon", "Darren", "Darwin"};

    public ShardSqlMapClientTemplateWithSqlActionShardingRouterTest() {
