...
public class ShardSqlSessionTemplateWithNamespaceRouterTest extends AbstractTestNGCobarClientTest {

    public ShardSqlSessionTemplateWithNamespaceRouterTest() {
    ...
    /**
     * since {@link ShardSqlSessionTemplate#execute(SqlMapClientCallback)}, {@link ShardSqlSessionTemplate#executeWithListResult(SqlMapClientCallback)
     * )} and {@link ShardSqlSessionTemplate#executeWithMapResult(SqlMapClientCallback) )} don't support partitioning behaviors, we can unit test
     * them together and use one of them as their representation.
     */
    ...
    /**
     * although we use queryForObject by querying on name column, but it doesn't mean 'name' column is unique, it's because of the data fixture we set
     * up to use.
     */
     ...
     * client corretly, make sure you are partitioning you databases with shard id that will not be changed once it's created!!!
     */
