...
public class ShardSqlSessionDaoSupportTestWithComposedRuleRouter extends AbstractTestNGCobarClientTest {

    private ShardSqlSessionDaoSupport dao = new ShardSqlSessionDaoSupport();
    ...
    public ShardSqlSessionDaoSupportTestWithComposedRuleRouter() {
