...
public class ShardSqlSessionTemplateWithNamespaceShardingRouterTest extends AbstractTestNGCobarClientTest {
    ...
    public ShardSqlSessionTemplateWithNamespaceShardingRouterTest() {
    ...
    /**
     * if no rule is found for current data access request, the data access request will be performed on default data source, that's, partition1.
     */
    ...
    /**
     * adapted from {@link ShardSqlSessionTemplateWithNamespaceRouterTest} with some adjustments.
     */
